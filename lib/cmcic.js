...
CMCIC.prototype.tpe.prototype.checkTransactionReturn = function(transactionData) {
	...
	transactionData.TPE = (transactionData.TPE === 'undefined') ? '' : transactionData.TPE;
	transactionData.date = (transactionData.date === 'undefined') ? '' : transactionData.date;
	transactionData.montant = (transactionData.montant === 'undefined') ? '' : transactionData.montant;
	transactionData.reference = (transactionData.reference === 'undefined') ? '' : transactionData.reference;
	transactionData['texte-libre'] = (transactionData['texte-libre'] === 'undefined') ? '' : transactionData['texte-libre'];
	transactionData.version = (transactionData.version === 'undefined') ? '' : transactionData.version;
	transactionData['code-retour'] = (transactionData['code-retour'] === 'undefined') ? '' : transactionData['code-retour'];
	transactionData.cvx = (transactionData.cvx === 'undefined') ? '' : transactionData.cvx;
	transactionData.vld = (transactionData.vld === 'undefined') ? '' : transactionData.vld;
	transactionData.brand = (transactionData.brand === 'undefined') ? '' : transactionData.brand;
	transactionData.status3ds = (transactionData.status3ds === 'undefined') ? '' : transactionData.status3ds;
	transactionData.numauto = (transactionData.numauto === 'undefined') ? '' : transactionData.numauto;
	transactionData.motifrefus = (transactionData.motifrefus === 'undefined') ? '' : transactionData.motifrefus;
	transactionData.originecb = (transactionData.originecb === 'undefined') ? '' : transactionData.originecb;
	transactionData.bincb = (transactionData.bincb === 'undefined') ? '' : transactionData.bincb;
	transactionData.hpancb = (transactionData.hpancb === 'undefined') ? '' : transactionData.hpancb;
	transactionData.ipclient = (transactionData.ipclient === 'undefined') ? '' : transactionData.ipclient;
	transactionData.originetr = (transactionData.originetr === 'undefined') ? '' : transactionData.originetr;
	transactionData.veres = (transactionData.veres === 'undefined') ? '' : transactionData.veres;
	transactionData.pares = (transactionData.pares === 'undefined') ? '' : transactionData.pares;
	...
	console.log(mac + " | "  + transactionData.MAC);
