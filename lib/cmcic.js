...
CMCIC.prototype.tpe.prototype.checkTransactionReturn = function(transactionData) {
	...
	console.log(mac.toUpperCase() + " / " + transactionData.MAC.toUpperCase());
	if (mac.toUpperCase() === transactionData.MAC.toUpperCase() && (transactionData['code-retour'] === 'paiement' ||  transactionData.code_retour === 'payetest')) {
		return {
			status: false,
