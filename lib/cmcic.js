...
CMCIC.prototype.transaction.prototype.getStringFromTexteLibre = function() {
	var result = '',
	i = 0;
...
CMCIC.prototype.transaction.prototype.form = function(id, autosubmit) {
	...
	texteLibre = this.getStringFromTexteLibre(),
	date = (this.date === "") ? this.getDate() : this.date,
	result = '<form method="post" id="'+id+'" action='+this.tpe.tpe.CMCIC_SERVEUR+'>'+
		...
		'<input type="hidden" name="texte-libre" value="'+texteLibre+'">'+
		'<div class="submit">'+
