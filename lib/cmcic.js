...
CMCIC.prototype.tpe.prototype.checkTransactionReturn = function(transactionData) {
	transactionData.TPE = (transactionData.TPE === 'undefined') | '';
	transactionData.date = (transactionData.date === 'undefined') | '';
	transactionData.montant = (transactionData.montant === 'undefined') | '';
	transactionData.reference = (transactionData.reference === 'undefined') | '';
	transactionData['texte-libre'] = (transactionData['texte-libre'] === 'undefined') | '';
	transactionData.version = (transactionData.version === 'undefined') | '';
	transactionData['code-retour'] = (transactionData['code-retour'] === 'undefined') | '';
	transactionData.cvx = (transactionData.cvx === 'undefined') | '';
	transactionData.vld = (transactionData.vld === 'undefined') | '';
	transactionData.brand = (transactionData.brand === 'undefined') | '';
	transactionData.status3ds = (transactionData.status3ds === 'undefined') | '';
	transactionData.numauto = (transactionData.numauto === 'undefined') | '';
	transactionData.motifrefus = (transactionData.motifrefus === 'undefined') | '';
	transactionData.originecb = (transactionData.originecb === 'undefined') | '';
	transactionData.bincb = (transactionData.bincb === 'undefined') | '';
	transactionData.hpancb = (transactionData.hpancb === 'undefined') | '';
	transactionData.ipclient = (transactionData.ipclient === 'undefined') | '';
	transactionData.originetr = (transactionData.originetr === 'undefined') | '';
	transactionData.veres = (transactionData.veres === 'undefined') | '';
	transactionData.pares = (transactionData.pares === 'undefined') | '';
