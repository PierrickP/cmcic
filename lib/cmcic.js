...
CMCIC.prototype.tpe = function (config) {
	var _tpe = {};
	var RETURN_OK = 'version=2\ncdr=0';
	var RETURN_NOTOK = 'version=2\ncdr=1';
...
CMCIC.prototype.tpe.prototype._setServer = function (bankName) {
...
CMCIC.prototype.tpe.prototype.checkTransactionReturn = function (transactionData) {
	...
	if (mac.toUpperCase() === transactionData.MAC.toUpperCase() && (transactionData['code-retour'] === 'paiement' ||  transactionData['code-retour'] === 'payetest')) {
		return {
			'status': true,
...
CMCIC.prototype.tpe.prototype.set = function (key, value) {
	var set = {};
	set[key] = value;
	this.configure(set);
...
CMCIC.prototype.tpe.prototype.get = function (key) {
	return this._tpe[key];
};
...
CMCIC.prototype.transaction.prototype._getDate = function () {
	var d = new Date();
