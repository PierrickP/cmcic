...
CMCIC.prototype.transaction.prototype.form = function(id, autosubmit) {
	...
	result = '<form method="post" id="'+id+'" action='+this.tpe.tpe.CMCIC_SERVEUR+'>'+
		...
		'<input type="hidden" name="montant" value="'+this.amount+this.tpe.tpe.CMCIC_CURRENCY+'">'+
		'<input type="hidden" name="reference" value="'+this.reference+'">'+
		'<input type="hidden" name="mail" value="'+this.email+'">'+
		'<input type="hidden" name="texte-libre" value="'+this.texteLibre+'">'+
		'<div class="submit">'+
